...
from src.utils.treeset import TreeSet
        ...
        while True:
            ...
            if self.check_trade_condition():
                ...
                for key, value in data.items():
                    if 'cci' in value:
                        self.send_message("my balance btc cci_bot {} {} {}".format(
                            self.btc_amount, self.symbol, self.coin_amount, self.chat)
#                self.notifier.sendLogMsg("my balance btc {} {} {}".format(
#                    self.btc_amount, self.symbol, self.coin_amount))
            print("my balance btc {} {} {}".format(self.btc_amount, self.symbol, self.coin_amount))
            self.log.write("my balance btc {} {} {}\n".format(self.btc_amount, self.symbol, self.coin_amount))
            self.log.flush()
            time.sleep(120)
